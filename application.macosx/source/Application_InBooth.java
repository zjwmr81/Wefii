...
public class Application_InBooth extends PApplet {
...
//press '8' to select choice "2" because we cover the the key '8' with '2' to make it like a phone-styled keypad  
 ...
 if (i == 3 && key == '7'){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--hide-stop", "Application_InBooth" };
    if (passedArgs != null) {
